...
int main(int argc, char* argv[])
{
  ...
  // input_data[0]   = NULL;
  // input_type[0]   = RKNN_TENSOR_FLOAT16;
  // input_layout[0] = RKNN_TENSOR_NHWC;
  // input_size[0]   = input_attrs[0].size;

  // input_data[1]   = NULL;
  // input_type[1]   = RKNN_TENSOR_FLOAT16;
  // input_layout[1] = RKNN_TENSOR_NHWC;
  // input_size[1]   = input_attrs[1].size;

  // input_data[2]   = NULL;
  // input_type[2]   = RKNN_TENSOR_FLOAT16;
  // input_layout[2] = RKNN_TENSOR_NHWC;
  // input_size[2]   = input_attrs[2].size;

  input_data[0]   = NULL;
  input_type[0]   = RKNN_TENSOR_INT8;
  input_layout[0] = RKNN_TENSOR_UNDEFINED;
  input_size[0]   = input_attrs[0].size;

  input_data[1]   = NULL;
  input_type[1]   = RKNN_TENSOR_INT8;
  input_layout[1] = RKNN_TENSOR_NHWC;
  input_size[1]   = input_attrs[1].size;

  input_data[2]   = NULL;
  input_type[2]   = RKNN_TENSOR_INT8;
  input_layout[2] = RKNN_TENSOR_NHWC;
  input_size[2]   = input_attrs[2].size;
...
for(int i=0; i<io_num.n_output; i++){
    ...
    float* out_data = (float*)outputs[i].buf;
